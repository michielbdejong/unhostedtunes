                       ...
                       bool             has)
{
    ...
    tr_bencDictAddInt (evt_data, "size", tor->completion.sizeNow);
    tr_bencDictAddInt (evt_data, "total", tor->info.totalSize);
    tr_event (NULL, tor, "torrent:progress", evt_data);
}
...
tr_torrentFileCompleted (tr_torrent * tor, tr_file_index_t fileNum)
{
    ...
    tr_benc* evt_data = tr_new (struct tr_benc, 1);
    tr_bencInitDict (evt_data, 2);
    tr_bencDictAddStr (evt_data, "tor", tor->info.hashString);
    tr_bencDictAddInt (evt_data, "file", fileNum);
    tr_event (NULL, tor, "torrent:file:complete", evt_data);
