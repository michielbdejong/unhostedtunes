...
am__v_AR_0 = @echo "  AR      " $@;
am__v_AR_1 = 
libdht_a_AR = $(AR) $(ARFLAGS)
libdht_a_LIBADD =
am_libdht_a_OBJECTS = dht.$(OBJEXT)
libdht_a_OBJECTS = $(am_libdht_a_OBJECTS)
...
am__v_CCLD_1 = 
SOURCES = $(libdht_a_SOURCES)
DIST_SOURCES = $(libdht_a_SOURCES)
...
LIBNATPMP_CFLAGS = @LIBNATPMP_CFLAGS@
LIBNATPMP_LIBS = @LIBNATPMP_LIBS@
LIBNATPMP_LIBS_QT = @LIBNATPMP_LIBS_QT@
LIBOBJS = @LIBOBJS@
LIBS = @LIBS@
LIBTOOL = @LIBTOOL@
LIBUPNP_CFLAGS = @LIBUPNP_CFLAGS@
LIBUPNP_LIBS = @LIBUPNP_LIBS@
LIBUPNP_LIBS_QT = @LIBUPNP_LIBS_QT@
LIBUTP_CFLAGS = @LIBUTP_CFLAGS@
LIBUTP_LIBS = @LIBUTP_LIBS@
LIBUTP_LIBS_QT = @LIBUTP_LIBS_QT@
LIPO = @LIPO@
LN_S = @LN_S@
LTLIBOBJS = @LTLIBOBJS@
MAKEINFO = @MAKEINFO@
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --gnu third-party/dht/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --gnu third-party/dht/Makefile
.PRECIOUS: Makefile
...
libdht.a: $(libdht_a_OBJECTS) $(libdht_a_DEPENDENCIES) $(EXTRA_libdht_a_DEPENDENCIES) 
	$(AM_V_at)-rm -f libdht.a
	$(AM_V_AR)$(libdht_a_AR) libdht.a $(libdht_a_OBJECTS) $(libdht_a_LIBADD)
	$(AM_V_at)$(RANLIB) libdht.a
...
@AMDEP_TRUE@@am__include@ @am__quote@./$(DEPDIR)/dht.Po@am__quote@
